...
export default function UniversityPortalProject() {
  ...
  return (
    <ProjectPageLayout
      title="NED University Portal"
      subtitle="Project #12: Full integration project."
      maxWidth="max-w-7xl"
      showCard={false}
      containerClassName="bg-[#f1f5f9]"
      backHoverColor="hover:text-[#002B5B]">
        ...
        <StatCard key={i} {...stat} />
            ...
            <div className="flex flex-col xl:flex-row gap-10">
                ...
                <div className="xl:w-[400px]">
                  ...
                  className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl hover:border-[#002B5B] focus:border-[#002B5B] focus:ring-0 focus:ring-transparent focus:bg-white font-bold text-black placeholder:text-slate-300"
                ...
                <div className="flex-1">
                  ...
                  className="w-full pl-12 pr-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl hover:border-[#002B5B] focus:border-[#002B5B] focus:ring-0 focus:ring-transparent focus:bg-white font-bold text-black text-sm placeholder:text-slate-300" />
          ...
          <div key={student.id} className="bg-white rounded-[2.5rem] p-8 border border-white shadow-xl shadow-slate-900/[0.03] group hover:scale-[1.02] transition-all hover:shadow-blue-900/[0.05]">
