...
export default function RegistrationProject() {
  ...
  return (
    <ProjectPageLayout
      ...
      subtitle="Project #03: User registration and display."
      maxWidth="max-w-7xl"
      showCard={false}
      containerClassName="bg-[#fafafa]"
      backHoverColor="hover:text-purple-600">
            ...
            <div className="flex flex-col lg:flex-row gap-12 sm:gap-16">
                  ...
                  className={`w-full px-4 py-4 bg-white border border-slate-200 rounded-2xl outline-none focus:outline-none transition-all font-bold text-slate-700 text-sm shadow-sm placeholder:text-slate-300 ${editingId ? 'focus:ring-2 focus:ring-transparent focus:border-cyan-500 focus:shadow-[0_0_0_4px_rgba(6,182,212,0.1)]' : 'focus:ring-2 focus:ring-transparent focus:border-purple-600 focus:shadow-[0_0_0_4px_rgba(147,51,234,0.1)]'}`} />
                    ...
                    className={`w-full px-4 py-4 bg-white border border-slate-200 rounded-2xl outline-none focus:outline-none transition-all font-bold text-slate-700 text-sm shadow-sm placeholder:text-slate-300 ${editingId ? 'focus:ring-2 focus:ring-transparent focus:border-cyan-500 focus:shadow-[0_0_0_4px_rgba(6,182,212,0.1)]' : 'focus:ring-2 focus:ring-transparent focus:border-purple-600 focus:shadow-[0_0_0_4px_rgba(147,51,234,0.1)]'}`} />
                            ...
                            <div className="flex gap-3">
                                <button
                  type="submit"
                  className={`flex-1 py-5 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all active:scale-95 shadow-sm ${editingId ? 'bg-cyan-600 text-white hover:bg-cyan-700' : 'bg-purple-600 text-white hover:bg-purple-700'}`
                  }>
                ...
                <button
                  type="button"
                  onClick={cancelEdit}
                  className="px-6 py-5 bg-slate-100 text-slate-600 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-200 transition-all">
                ...
                <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <AnimatePresence mode='popLayout'>
                            {profiles.length === 0 ?
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="col-span-full py-32 text-center rounded-[2.5rem] border border-dashed border-slate-200 bg-white/50">
              ...
              profiles.map((profile) => {
                ...
                return (
                  <motion.div
                    ...
                    className="p-6 bg-white border border-slate-100 rounded-[2rem] relative group hover:shadow-xl hover:shadow-slate-100/30 transition-all duration-300">
                          ...
                          <button
                            ...
                            className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-cyan-600 hover:bg-cyan-50 rounded-full transition-all sm:opacity-0 group-hover:opacity-100">
                            ...
                            className="w-4 h-4 rounded-full bg-rose-50 border border-rose-200 flex items-center justify-center hover:bg-rose-500 hover:border-rose-500 transition-all active:scale-75"
