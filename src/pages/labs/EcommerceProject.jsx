  ...
  if (showCheckout) {
    return (
      <ProjectPageLayout
        ...
        subtitle="Project #06: Multi-page e-commerce."
        maxWidth="max-w-4xl"
        showCard={false}
        containerClassName="bg-[#fdfcfb]"
        backHoverColor="hover:text-[#78350f]"
        rightElement={
        <button
          onClick={() => setShowCheckout(false)}
          className="p-4 bg-white text-[#78350f] rounded-2xl shadow-xl shadow-stone-200 hover:scale-105 active:scale-95 transition-all flex items-center gap-3 font-black text-[10px] uppercase tracking-widest">
            ...
            <motion.div
              ...
              className="absolute inset-0 z-50 flex items-center justify-center p-4 bg-white/60 backdrop-blur-sm rounded-[2.5rem]">
                                ...
                                <div className="bg-[#78350f] text-white p-12 rounded-[3.5rem] text-center shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5),0_30px_60px_-30px_rgba(0,0,0,0.6)] max-w-sm w-full border border-white/5 relative overflow-hidden">
                                    ...
                                    <button
                  onClick={resetStore}
                  className="w-full py-5 bg-white text-[#78350f] rounded-2xl font-black text-[10px] uppercase tracking-[0.4em] hover:bg-[#a44a3f] hover:text-white hover:scale-[1.02] transition-all active:scale-95 shadow-2xl shadow-black/40">
              ...
              className="w-full py-6 bg-[#78350f] text-white rounded-2xl font-black text-xs uppercase tracking-[0.4em] hover:bg-[#a44a3f] shadow-2xl shadow-stone-200 transition-all active:scale-95 flex items-center justify-center gap-4 focus-visible:ring-4 focus-visible:ring-[#78350f]/20 outline-none">
  ...
  return (
    <ProjectPageLayout
      ...
      <button
        ...
        className="relative p-5 bg-[#78350f] text-white rounded-2xl shadow-2xl shadow-stone-200 hover:scale-110 active:scale-90 transition-all group focus-visible:ring-4 focus-visible:ring-[#78350f]/20 outline-none">
        
                    <ShoppingCart size={24} />
                    {cartCount > 0 &&
        <span className="absolute -top-2 -right-2 bg-[#a44a3f] text-white text-[9px] font-black min-w-[22px] h-[22px] rounded-full flex items-center justify-center border-[2.5px] border-white shadow-lg px-0.5">
                            {cartCount}
                        </span>
        }
                </button>
            ...
            className="walnut-input w-full pl-14 pr-8 py-5 bg-stone-50 rounded-2xl outline-none font-bold text-[#78350f] transition-all placeholder:text-stone-300" />
                ...
                <div className="md:col-span-3 flex items-center gap-4 overflow-x-auto pb-4 scrollbar-hide">
                    {["All", "Furniture", "Lighting", "Decor"].map((cat) =>
          <button
            key={cat}
        ...
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          className="group bg-white rounded-[2.5rem] overflow-hidden border border-stone-50 hover:shadow-2xl hover:shadow-stone-200 transition-all duration-500 flex flex-col">
                ...
                className="px-6 py-3 bg-[#78350f] text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-[#a44a3f] transition-all active:scale-95 shadow-xl shadow-stone-100 focus-visible:ring-4 focus-visible:ring-[#78350f]/20 outline-none">
