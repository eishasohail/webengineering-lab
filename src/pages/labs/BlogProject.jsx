...
export default function BlogProject() {
  ...
  return (
    <ProjectPageLayout
      title="Palestine Stories"
      subtitle="Project #11: Blog mini-app with routing."
      maxWidth="max-w-7xl"
      showCard={false}
      containerClassName="bg-[#f0fdf4]"
      backHoverColor="hover:text-emerald-600">
        ...
        <motion.div
          ...
          <motion.article
            ...
            className="group bg-white rounded-[2.5rem] overflow-hidden border border-emerald-200 hover:shadow-2xl shadow-emerald-900/10 transition-all cursor-pointer flex flex-col h-full active:scale-[0.98]">
        ...
        <motion.div
          ...
          className="max-w-4xl mx-auto">
            ...
            className="flex items-center gap-2 text-xs font-black text-emerald-600 mb-10 hover:gap-4 transition-all uppercase tracking-[0.2em]">
